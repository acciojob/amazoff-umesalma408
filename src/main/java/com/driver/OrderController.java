...
OrderService orderService;
    ...
    public ResponseEntity<String> addOrderPartnerPair(@RequestParam String orderId, @RequestParam String partnerId){
       //addOrderPartnerPair
        orderService.assignOrderPartnerPairToDB(orderId,partnerId);
    ...
    public ResponseEntity<Integer> getOrdersLeftAfterGivenTimeByPartnerId(@PathVariable String time, @PathVariable String partnerId){
        ...
        Integer countOfOrders = orderService.getOrderLeftAfterTimePartnerId(time,partnerId);
    ...
    public ResponseEntity<String> deletePartnerById(@PathVariable String partnerId){
        ...
        orderService.deleteAllPartnersById(partnerId);
    ...
    public ResponseEntity<String> deleteOrderById(@PathVariable String orderId){
        ...
        orderService.deleteAllOrderId(orderId);
